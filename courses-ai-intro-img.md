...
- Тестовая группа №1. Семинар завершён.
...
- Участие в онлайн семинаре, примерная длительность — 1,5 часа.
- Возможность задавать вопросы во время семинара.
- Рассылка подробной памятки по материалам занятия.
...
- При покупке Базового пакета, видео-запись можно приобрести отдельно после проведения семинара за 1 500 рублей.

## Оферта

Условия оферты доступны по этой [ссылке](/offer/).

## Пользовательское соглашение

Условия пользовательского соглашения доступны по этой [ссылке](/user-agreement/).
